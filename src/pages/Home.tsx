        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            <div className="inline-block bg-accent/10 text-accent rounded-full px-3 py-1 text-sm font-medium mb-6">
              Discover the world with Di&Choi
            </div>
      ...
      <section className="py-20 bg-secondary/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">Why Choose Di&Choi</h2>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Join thousands of travelers who have discovered perfect journeys with Di&Choi.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                quote: "Di&Choi transformed how I plan my trips. The AI recommendations were spot on and saved me hours of research.",
